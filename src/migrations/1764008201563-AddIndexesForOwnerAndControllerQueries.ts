  ...
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_ant_record_controllers_gin 
    ...
    await queryRunner.query(`
      CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_ant_record_owner 
      ON ant_record (owner)
    `);
    ...
    await queryRunner.query(`
      CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_ant_record_owner_created 
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      DROP INDEX CONCURRENTLY IF EXISTS idx_ant_record_owner_created
    `);

    await queryRunner.query(`
      DROP INDEX CONCURRENTLY IF EXISTS idx_ant_record_owner
    `);

    await queryRunner.query(`
      DROP INDEX CONCURRENTLY IF EXISTS idx_ant_record_controllers_gin
    `);
  }
}
